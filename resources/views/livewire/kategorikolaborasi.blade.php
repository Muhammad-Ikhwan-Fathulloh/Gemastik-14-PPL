...
<div wire:ignore.self class="modal fade" id="addkategori" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <input type="text" name="kategori_collabs" wire:model="kategori_collabs" class="form-control" placeholder="Masukkan Kategori">
    @error('kategori_collabs') <div class="alert alert-danger">{{ $message }}</div> @enderror
  </div>
        <!-- Form -->
      </div>
...
<div wire:ignore.self class="modal modal-danger fade" id="delete{{ $datas->id }}">
  <div class="modal-dialog modal-sm">
    <div class="modal-content bg-ku">
      <div class="modal-header">
        <h5 class="modal-title text-white" id="exampleModalLabel"><i class="fas fa-fw fa-map"></i> {{ $datas->kategori_collabs }}</h5>
